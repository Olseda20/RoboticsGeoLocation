...
def move_to_goal(destination_location, velocity_publisher, rate):
  ...
  try:
    ...
    while distance_to_goal >= 1:
      ...
      updated_linear_velocity = TurtleMotion.calculate_linear_velocity(distance_to_goal, 1.0)
      updated_angular_velocity = TurtleMotion.calculate_angular_velocity(theta_to_goal, POSE.theta, 10)
...
def main(goal_x = None, goal_y = None):
  ...
  move_to_goal([goal_x, goal_y], velocity_publisher, rate)
